...
import type { DriverProfile, DriverProfileRepository, RaceHistoryRow, TrainingJob } from "./repository.js";

export function createRepository(dbPath: string): DriverProfileRepository {
  return new SqliteDriverProfileRepository(dbPath);
}

export type { DriverProfile, DriverProfileRepository, RaceHistoryRow, TrainingJob };
